...
struct qt_meta_stringdata_CLASSdebuggerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSdebuggerENDCLASS = QtMocHelpers::stringData(
    "debugger",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSdebuggerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject debugger::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSdebuggerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSdebuggerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSdebuggerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *debugger::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSdebuggerENDCLASS.stringdata0))
